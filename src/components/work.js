                    ...
                    <Cell col={6}>
                        <div className="project-card1">
                            <Card shadow={0} style={{width: '512px', height:'350px', margin: 'auto', background:'#00c6ff'}}>
                                ...
                                <CardText>
                                    <h6 style={{color: '#fff'}}>Wine Empire is an online store that sells and delivers wine/spirit/beer online in Africa.</h6>
                                </CardText>
                                <CardActions border>
                                    <Button style={{color: '#fff', fontFamily: 'Josefin Slab'}} colored href = 'https://www.wineempire.store'>Click here to Check wineempire</Button>
                                </CardActions>
                    ...
                    <Cell col={6}>
                        <div className='project-card2' style={{left: '100', top: '25'}}>
                            <Card shadow={0} style={{width: '512px', height:'350px', margin: 'auto', background:'#00c6ff'}}>
                                ...
                                <CardText>
                                    <h6 style={{color: '#fff'}}>RUBi is an AI algorithm that was developed in python by my team and I to minimized the power consumption 
                                        of an IOT enable house that get energy from solar panels. </h6>
                                </CardText>
                                <CardActions border>
                                    <Button style={{color: '#fff', fontFamily: 'Josefin Slab'}} colored href='https://github.com/robynkwamo/RUBi.git'>Click here to look at RUBi's code</Button>
                                </CardActions>
                                <CardMenu style={{color: '#fff'}}>
                                    <IconButton name="share" />
                                </CardMenu>
