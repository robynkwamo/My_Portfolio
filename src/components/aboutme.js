                    ...
                    <Cell className='aboutMe-cell' col = {9}>
                        ...
                        <h2>
                            <p className='aboutMe-para1'>
                                ...
                                My way of doing it is through technology because I think that it has so much influence in today's world.
                        ...
                        <h2>
                            <p className='aboutMe-para1'>
                                ...
                                that customers may have and also get customers information for our customer catalog. 
                                Then I got a student visa to come study in the United States. 
                                I came directly to Houston, and I started English 
                                courses at the University of Houston since I did not speak english at the time. 
                                Then after six months of english classes, I transferred to Houston Community College 
                                where I started and finished my associate degree in science. Two years later, 
                                I was accepted at Texas A&M to pursue a bachelor in Computer Engineering where I am currently a student.
                            </p>
                        </h2>
                        <h1>
                            Hobby
                        ...
                        <h2>
                            <p className='aboutMe-para1'>
                                One of the greatest things that I like is spending time with friends and familly. For me that's where resides my happiness.
                                I also like music, and I am a DJ on my free time. Music is one of the things that usually puts me in my right mind.
                                I think I am a techie because I like building new tech gadgets and use them for different purposes. Watching documentaries
                                about different construction mechanisms and theories. 
                            </p>
                        </h2>
                        <h1>
                            Fun Facts
                        ...
                        <h2>
                            <p className='aboutMe-para1'>
                                ...
                                When I am engaged in a conversation, I tend to adopt the attitude of listening, so as to better understand, and not hearing to argue. 
                        ...
                        <h2>
                            <p className='aboutMe-para1'>
                                My goal in life is greatly influenced by a person whose inspiration changed my life's trajectory. 
                                I hope to be not only a source of inspiration to less privileged youths in underdeveloped countries, 
                                but also a guide and mentor. I aim to make my parents proud, which to me is valuable gratitude to them for 
                                the gift of life.
                            </p>
                        </h2>
                    </Cell>
