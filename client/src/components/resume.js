...
class Resume extends Component {
  ...
  render() {
    ...
    if (this.state.display) {
      content1 = <Skills skill1="Python" progress1={94} skill2="C++" progress2={90} skill3="Java" progress3={92} />;
      content2 = (
        <Skills skill1="React" progress1={95} skill2="Node.JS" progress2={90} skill3="React Native" progress3={82} />
      );
      content3 = (
        <Skills skill1="HTML\CSS" progress1={90} skill2="JavaScript" progress2={90} skill3="PHP" progress3={71} />
      );
      content4 = (
        <Skills skill1="SQLite" progress1={84} skill2="FireBase" progress2={82} skill3="MySQL" progress3={35} />
      );
      content5 = (
        <Skills
      ...
      content6 = (
        <Skills skill3="Photoshop" progress3={73} skill2="AdobeXD" progress2={84} skill1="PowerPoint" progress1={89} />
      );
      content7 = (
        <Skills skill1="French" progress1={99} skill2="English" progress2={92} skill3="Spanish" progress3={10} />
      );
    }
          ...
          <Grid>
            <Cell className="resume-left-col" col={4}>
              ...
              <p style={{ fontSize: '18px' }}>
                I am a Computer Engineering working as a Fullstack developer who graduated from Texas A&M in December of
                2019. I'm working to expand my knowledge across the various areas of computer Engineering specifically
                in the area of Cyber Security and web development. I aspire to use the skills and knowledge that I have
                acquired so far to develop ideas and applications that makes the world a better place.
              </p>
              <hr style={{ borderTop: '3px solid #ffe767', width: '50%' }} />
              <h5
                style={{
              ...
              <p style={{ fontSize: '18px' }}>
                <a href="mailto:nkwamoroby@gmail.com" style={{ color: '#000000' }}>
            ...
            <Cell className="resume-right-col" col={8}>
              ...
              <Experience
                ...
                jobName={'Texas A&M Dwight Look College of Engineering, Engineering Online'}
              ...
              <p style={{ color: 'white', fontFamily: 'Acme', fontSize: '15px' }}>
                <p>
                  <a style={{ color: 'white' }} href="http://courses.cse.tamu.edu/keyser/csce121/">
                    CSCE 121:INTRO TO PROGRAM DESIGN AND CONCEPTS
                  </a>
                </p>
                <p>
                  <a style={{ color: 'white' }} href="http://courses.cs.tamu.edu/teresa/csce221/csce221-index.html">
                    CSCE 221:DATA STRUCTURES AND ALGORITHMS
                  </a>
                </p>
                <p>
                  <a style={{ color: 'white' }} href="http://faculty.cs.tamu.edu/shsze/courses/spring17/">
                    CSCE 222:DISCRETE STRUCTURES FOR COMPUTING
                  </a>
                </p>
                <p>
                  <a style={{ color: 'white' }} href="http://faculty.cse.tamu.edu/tanzir/sp19/313/">
                    CSCE 313:INTRO TO COMPUTER SYSTEM
                  </a>
                </p>
                <p>
                  <a style={{ color: 'white' }} href="http://faculty.cse.tamu.edu/tanzir/sp19/315/">
                    CSCE 315:PROGRAMMING STUDIO
                  </a>
                </p>
                <p>
                  <a style={{ color: 'white' }} href="http://courses.cse.tamu.edu/guofei/csce465/">
                ...
                <p>
                  <a style={{ color: 'white' }} href="http://www.ece.tamu.edu/~spalermo/ecen325.html">
                ...
                <p>
                  <a style={{ color: 'white' }} href="http://ece.tamu.edu/~sunilkhatri/courses/ee449/">
                    ECEN 449:MICROPROCESSOR SYSTEM DESIGN
                  </a>
                </p>
                <p>
                  <a style={{ color: 'white' }} href="http://ece.tamu.edu/~jyyz/ecen454.html">
                    ECEN 454:DIGITAL INTEGRAL CIRCUIT DESIGN
                  </a>
                </p>
                <p>
                  <a style={{ color: 'white' }} href="https://cesg.tamu.edu/courses/ecen-489-mob-apps-android/">
                ...
                <p>
                  <a style={{ color: 'white' }} href="https://engineering.tamu.edu/student-life/eep/courses.html">
                    ENGR 462:ENGINEERING ENTREPRENEURSHIP HOUR
                  </a>
                </p>
                <p>
                  <a style={{ color: 'white' }} href="https://core.tamu.edu/pdf/ENGR%20482-Syllabus.pdf">
                    ENGR 482:ETHICS AND ENGINEERING
                  </a>
                </p>
                <p>
                  <a style={{ color: 'white' }} href="https://www.math.tamu.edu/courses/math311/">
